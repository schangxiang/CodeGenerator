...
namespace EMS.PM.Business
{
    ...
    /// XXXX 业务逻辑类
    /// </summary>
    public class BLLNAMEHERE :IBLLNAMEHERE 
    {

		#region 定义变量

        DAONAMEHERE dao = new DAONAMEHERE();
        ...
        {
            return dao.GetENTITYNAMEHEREList();
        }
        ...
        {
            return dao.InsertENTITYNAMEHERE(item);
        }
        ...
        {
            return dao.DeleteENTITYNAMEHERE(itemGUID);
        }
        ...
        {
            return dao.UpdateENTITYNAMEHERE(item);
        }
        ...
        {
            return dao.GetENTITYNAMEHEREByID(itemGUID);
        }
...
bllName=raw_input("Enter BLLNAMEHERE:")
daoName=raw_input("Enter DAONAME:");



fileHeader = fileHeader.replace("IBLLNAMEHERE",ibllName)
fileHeader = fileHeader.replace("BLLNAMEHERE",bllName)
