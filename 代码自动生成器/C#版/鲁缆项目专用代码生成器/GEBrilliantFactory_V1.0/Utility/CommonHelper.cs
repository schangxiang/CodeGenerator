...
namespace GenerateCode_GEBrilliantFactory
{
    ...
    public class CommonHelper
    {
        ...
        /// <returns></returns>
        public static string RepalceNameSpace(string oldValue)
        {
            oldValue = oldValue.Replace("$namespace_model$", SysData.namespace_model);
            oldValue = oldValue.Replace("$namespace_dal$", SysData.namespace_dal);
            oldValue = oldValue.Replace("$namespace_bll$", SysData.namespace_bll);
            oldValue = oldValue.Replace("$namespace_wcf$", SysData.namespace_wcf);
            oldValue = oldValue.Replace("$namespace_common$", SysData.namespace_wcf);
            return oldValue;
        }
        /// <summary>
        /// 获取存储过程名
