...
namespace GenerateCode_GEBrilliantFactory
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            this.tb_WCF_NameSpacePath.Text = ConfigurationManager.AppSettings["namespaceValue"].ToString();
            this.tb_CreatePerson.Text = ConfigurationManager.AppSettings["CreatePerson"].ToString();//创建人
            this.tb_namespace_bll.Text = ConfigurationManager.AppSettings["namespace_bll"].ToString();
            this.tb_namespace_dal.Text = ConfigurationManager.AppSettings["namespace_dal"].ToString();
            this.tb_namespace_model.Text = ConfigurationManager.AppSettings["namespace_model"].ToString();
            this.tb_namespace_wcf.Text = ConfigurationManager.AppSettings["namespace_wcf"].ToString();
            this.tb_namespace_common.Text = ConfigurationManager.AppSettings["namespace_common"].ToString();
        ...
        {
            var aa= this.tb_WCF_NameSpacePath.Text;
            SysData.namespace_bll = aa+this.tb_namespace_bll.Text;
            SysData.namespace_dal = aa + this.tb_namespace_dal.Text;
            SysData.namespace_model = aa + this.tb_namespace_model.Text;
            SysData.namespace_wcf = aa + this.tb_namespace_wcf.Text;
            SysData.namespace_common = aa + this.tb_namespace_common.Text;
        }
