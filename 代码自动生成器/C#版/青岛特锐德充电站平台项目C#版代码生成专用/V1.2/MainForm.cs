...
namespace GenerateModel
{
    public partial class MainForm : Form
    {
        ...
        {
            bool tf = Export2File(tbPath.Text, _tableName, BLLGenerate.CreateBLLClass(moduleName, chinaComment, entityName, entityProName, nameSpacePath, createPerson,mapName), "BLL", moduleName, entityName);
        }
