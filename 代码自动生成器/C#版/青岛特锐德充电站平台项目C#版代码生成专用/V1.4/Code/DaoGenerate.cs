 ...
 */ ";
            ...
            sbContent.Append("      List<$EntityName$> Get$ModuleName$ByFilter(IDictionary<string, object> dictParam); \n");
            ...
            sbContent.Append("      IList<$EntityName$> Get$ModuleName$ListForPaging(IDictionary<string, object> dictParam); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      /// <param name=\"htParam\">查询过滤条件</param> \n");
            sbContent.Append("      /// <returns>实体集合</returns> \n");
            sbContent.Append("      int Get$ModuleName$ListForPagingCount(IDictionary<string, object> dictParam); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      object Add$ModuleName$($EntityName$ $EntityProName$); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      int Edit$ModuleName$($EntityName$ $EntityProName$); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      /// <returns>影响的记录行数</returns> \n");
            sbContent.Append("      int Remove$ModuleName$(string keyID); \n");
            sbContent.Append("      #endregion  \n\n");

            string daoContent = header + sbContent.ToString() + footer;

            //替换文本
            daoContent = daoContent.Replace("$ModuleName$", moduleName);//模块名称
