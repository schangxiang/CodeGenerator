 ...
 */ ";
            ...
            header += "using System;\n"
                ...
                + "    /// " + chinaComment + "业务逻辑接口\n"
                + "    /// </summary>\n"
                + "    public interface I$ModuleName$BLL {\n\n";
            string footer = "    }\n" + "}";
            ...
            sbContent.Append("      IDictionary<string, object> Get$ModuleName$ListForPaging(IDictionary<string, object> dictParam); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      bool Add$ModuleName$($EntityName$ $EntityProName$); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      /// <param name=\"$EntityProName$\">$ChinaComment$Model</param> \n");
            sbContent.Append("      /// <returns>true:成功，false:失败</returns> \n");
            sbContent.Append("      bool Edit$ModuleName$($EntityName$ $EntityProName$); \n");
            sbContent.Append("      #endregion  \n\n");
            ...
            sbContent.Append("      /// <returns>true:成功，false:失败</returns> \n");
            sbContent.Append("      bool Remove$ModuleName$(string keyID); \n");
            sbContent.Append("      #endregion  \n\n");

            string IBLLContent = header + sbContent.ToString() + footer;

            //替换文本
            IBLLContent = IBLLContent.Replace("$ModuleName$", moduleName);//模块名称
