 ...
 */ ";
            ...
            header += "using System;\n"
                ...
                + "    /// " + chinaComment + "控制器\n"
                + "    /// </summary>\n"
                + "    public class $WarnMeasure$Controller:AuthBaseController {\n\n";
            string footer = "    }\n" + "}";
            ...
            sbContent.Append("      public ActionResult $WarnMeasure$()\n");
            sbContent.Append("      {\n");
            ...
            sbContent.Append("      /// Date：$NowTimeStr$ \n");
            sbContent.Append("      /// </summary> \n");
            sbContent.Append("      public ActionResult $WarnMeasure$Detail()\n");
            sbContent.Append("      {\n");
            ...
            sbContent.Append("              List<TestEntity> list = testBll.GetTestByFilter(dict);\n");
            sbContent.Append("              if (list != null && list.Count == 1)");
            sbContent.Append("              {\n");
            sbContent.Append("                  ViewBag.TestEntity = list[0];\n");
            sbContent.Append("              }\n");
            ...
            sbContent.Append("      public ActionResult Get$WarnMeasure$ByFilter() \n");
            sbContent.Append("      { \n");
            ...
            sbContent.Append("              List<$EntityName$> $EntityProName$List = $EntityProName$Bll.Get$WarnMeasure$ByFilter(filter); \n");
            ...
            sbContent.Append("      /// Date：$NowTimeStr$ \n");
            sbContent.Append("      /// </summary> \n");
            sbContent.Append("      public ActionResult Get$WarnMeasure$ListForPaging() \n");
            sbContent.Append("      { \n");
            sbContent.Append("          try \n");
            sbContent.Append("          { \n");
            sbContent.Append("              IDictionary<string, object> filter = new Dictionary<string, object>(); \n");
            ...
            sbContent.Append("              \n");
            sbContent.Append("              IDictionary<string, object> dataList= $EntityProName$Bll.Get$WarnMeasure$ListForPaging(filter); \n");
            sbContent.Append("              //格式化数据");
            sbContent.Append("\n");
            sbContent.Append("              IsoDateTimeConverter timeConverter = new IsoDateTimeConverter();\n");
            sbContent.Append("              timeConverter.DateTimeFormat = \"yyyy'-'MM'-'dd HH:mm:ss\";//时间格式\n");
            ...
            sbContent.Append("      public ActionResult Add$WarnMeasure$() \n");
            sbContent.Append("      { \n");
            sbContent.Append("          try \n");
            sbContent.Append("          { \n");
            ...
            sbContent.Append("      /// </summary> \n");
            sbContent.Append("      /// <returns></returns> \n");
            sbContent.Append("      public ActionResult Edit$WarnMeasure$() \n");
            sbContent.Append("      { \n");
            sbContent.Append("          try \n");
            sbContent.Append("          { \n");
            ...
            sbContent.Append("      /// </summary> \n");
            sbContent.Append("      /// <returns></returns> \n");
            sbContent.Append("      public ActionResult Remove$WarnMeasure$() \n");
            sbContent.Append("      { \n");
            sbContent.Append("          try \n");
            sbContent.Append("          { \n");
