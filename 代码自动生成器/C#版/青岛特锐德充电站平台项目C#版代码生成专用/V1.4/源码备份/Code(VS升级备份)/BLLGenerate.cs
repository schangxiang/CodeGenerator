 ...
 */ ";
            ...
            sbContent.Append("      /// </summary> \n");
            sbContent.Append("      I$WarnMeasure$Dao $EntityProName$Dao = DaoService.GetInstance(SqlMap.$mapName$).GetDao<I$WarnMeasure$Dao>(); \n");
            ...
            sbContent.Append("      public List<$EntityName$> Get$WarnMeasure$ByFilter(IDictionary<string, object> dictParam) \n");
            sbContent.Append("      { \n");
            sbContent.Append("          try \n");
            sbContent.Append("          { \n");
            sbContent.Append("              return $EntityProName$Dao.Get$WarnMeasure$ByFilter(dictParam); \n");
            sbContent.Append("          }\n");
            ...
            sbContent.Append("      public IDictionary<string, object> Get$WarnMeasure$ListForPaging(IDictionary<string, object> dictParam)\n");
            sbContent.Append("      { \n");
            sbContent.Append("          try \n");
            sbContent.Append("          { \n");
            sbContent.Append("              IDictionary<string, object> retDict= new Dictionary<string, object>(); \n");
            sbContent.Append("              int count = $EntityProName$Dao.Get$WarnMeasure$ListForPagingCount(dictParam); \n");
            sbContent.Append("              IList<$EntityName$> list = $EntityProName$Dao.Get$WarnMeasure$ListForPaging(dictParam); \n");
